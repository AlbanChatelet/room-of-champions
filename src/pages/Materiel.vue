...
<main class="bg-[#000011] p-6 md:p-24">
        ...
        <div class="flex flex-col md:flex-row pt-10">
            <div class="md:w-1/2">
                <h1 class="font-poppins font-black text-2xl md:text-4xl text-white pl-4 md:pl-16 pb-6">
                    <span class="text-9xl">01.</span><span class="text-[#00c9c6] pl-8">LA SOURIS</span>
                </h1>
            ...
            <img src="/src/assets/souris.png" alt="souris" class="md:w-1/2 w-full h-auto rounded-3xl mt-6 md:mt-0">
        </div>
</main>
</template>